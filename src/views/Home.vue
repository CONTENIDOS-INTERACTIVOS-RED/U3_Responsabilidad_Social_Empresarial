        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La responsabilidad social empresarial (RSE) busca integrar los objetivos económicos con el bienestar social y ambiental, fomentando la sostenibilidad y la competitividad. La colaboración entre empresas y organizaciones no gubernamentales refuerza el impacto social, mientras que las pequeñas y medianas empresas destacan al generar valor mixto mediante modelos que combinan beneficios económicos, sociales y ambientales. No obstante, desafíos como la corrupción y el soborno comprometen la integridad empresarial. Para contrarrestarlos, resultan esenciales estrategias como la implementación de códigos de conducta, la formación continua y las evaluaciones, promoviendo así la transparencia, la confianza y un desarrollo empresarial sostenible.
